...
},{"./utils":"en4he","./Counter":"cGgjj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"en4he":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"cGgjj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _utils = require("./utils");
function Counter() {
    ...
    let count = 0;
    const label = (0, _utils.createElement)("label", {
        className: "counter-label",
        textContent: count
    });
    const labelContainer = (0, _utils.createElement)("div", {}, [
        label
    ]);
    const incButton = (0, _utils.createElement)("button", {
        className: "counter-button",
        textContent: "+"
    });
    const decButton = (0, _utils.createElement)("button", {
        className: "counter-button",
        textContent: "-"
    });
    incButton.addEventListener("click", ()=>updateCount(label, ++count));
    decButton.addEventListener("click", ()=>updateCount(label, --count));
    const footer = (0, _utils.createElement)("footer", {
...
},{"./utils":"en4he","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequirea26a")
